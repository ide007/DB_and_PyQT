...
class Server(threading.Thread, metaclass=ServerMaker):
            ...
            if recv_data_lst:
                for client_with_message in recv_data_lst:
                    try:
                        ...
                        # Ищем клиента в словаре клиентов и удаляем его из
                        # него и  базы подключённых
    ...
    # словарь сообщение, список зарегистрированных
    ...
    def process_client_message(self, message, client):
        ...
        # Если это сообщение, то добавляем его в очередь сообщений, проверяем
        # наличие в сети, и отвечаем.
        ...
        # Если клиент выходит
            ...
            logger.info(f'Клиент {message[ACCOUNT_NAME]} корректно отключился'
                        f' от сервера.')
