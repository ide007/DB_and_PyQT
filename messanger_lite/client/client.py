...
from messanger_lite.client.client import start_dialog
from messanger_lite.client.common import ServerError
from messanger_lite.client.common import log
from messanger_lite.client.client import ClientDatabase
from messanger_lite.client.client import ClientTransport
from messanger_lite.client.client import ClientMainWindow
...
def arg_parser():
    ...
    if not 1023 < server_port < 65536:
        logger.critical(
            ...
            f'{server_port}. Допустимы адреса с 1024 до 65535. Выход.')
        sys.exit(1)
